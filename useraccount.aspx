<%@ Page Language="C#" AutoEventWireup="true" CodeFile="useraccount.aspx.cs" EnableEventValidation="false" Inherits="ProductDet" %>
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">List of Your Order</h1>
    ...
    <div class="container-fluid py-5">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="order_id" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" Width="100%" >
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField DataField="order_id" HeaderText="Name of Product" ReadOnly="True" />
                <asp:BoundField DataField="order_date" HeaderText="Date of Order" />
                <asp:BoundField DataField="total_amount" HeaderText="Color" />
                <asp:CommandField ShowDeleteButton="True" DeleteText="Cancel Order" />
            </Columns>
        ...
        <asp:Label ID="Label2"  runat="server" Visible="false" Text="No Order Found!!!!"></asp:Label>
    </div>
    <!-- Shop Detail End -->
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">List of Your Selling Product</h1>
            
        </div>
    </div>

    <div class="container-fluid py-5">
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="product_id" ForeColor="#333333" GridLines="None"  Width="100%" >
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField DataField="product_name" HeaderText="Name of Product" ReadOnly="True" />
                <asp:BoundField DataField="price" HeaderText="Price" />
                <asp:BoundField DataField="quantity" HeaderText="Quantity" />
                <asp:CommandField ShowDeleteButton="True" DeleteText="Cancel Sale" />
            </Columns>
            <EditRowStyle BackColor="#999999" />
            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
        ...
        <asp:Label ID="Label3"  runat="server" Visible="false" Text="No Selling Found!!!!"></asp:Label>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="text-center mb-4">
            ...
            <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn-outline-dark" NavigateUrl="~/Registeredit.aspx" BackColor="#FFFF99" BorderColor="#003300" BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" Font-Names="Arial" Font-Size="Larger" ForeColor="#000099" Height="35px" Width="300px" >Edit Profile</asp:HyperLink>
