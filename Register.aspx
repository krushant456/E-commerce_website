<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" EnableEventValidation="true" Inherits="Register" %>
...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            <a href="login.aspx" class="nav-item nav-link">Login(Buyer/Seller)</a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Registration(Buyer/Seller)</h1>
                ...
                <div class="contact-form">
                    <div id="success"></div>
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" name="uname" id="uname" runat="server" placeholder="Your Name"
                                required="required" data-validation-required-message="Please enter your name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="email" class="form-control" name="email" id="email" runat="server" placeholder="Your Email"
                                required="required" data-validation-required-message="Please enter your email" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                             <input type="number" class="form-control" name="contactno" id="contactno" runat="server" placeholder="Your Mobile No."
                                required="required" data-validation-required-message="Please enter your mobileno." />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="6" name="address" id="address" runat="server" placeholder="Address"
                                required="required"
                                data-validation-required-message="Please enter your Address"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <select name="area" id="area" class="form-control" runat="server" >
                               
                            </select>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <select name="city" id="city" class="form-control" runat="server" >
                               
                            </select>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <select name="state" id="state" class="form-control" runat="server" >
                               
                            </select>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <select name="usertype" id="usertype" class="form-control" runat="server" >
                        ...
                        <div class="control-group">
                            <strong>Select Subscription Type : </strong>&nbsp;&nbsp;<asp:DropDownList ID="subtype" runat="server" AutoPostBack="True" OnSelectedIndexChanged="subtype_SelectedIndexChanged"></asp:DropDownList>
                            <%--<select name="subtype" id="subtype" class="form-control" runat="server" >
                                
                            </select>--%>
                            <label id="subdet" name="subdet" runat="server" class="alert-info">
                            </label>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" name="bankname" id="bankname" runat="server" placeholder="Bank Name/E-Wallet Name"
                                required="required" data-validation-required-message="Please Bank name of E-Wallet Name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" name="transno" id="tansno" runat="server" placeholder="Enter Transaction no."
                                required="required" data-validation-required-message="Please enter User Name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" name="amount" id="amount" runat="server" placeholder="Amount Paid"
                                required="required" data-validation-required-message="Please enter User Name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" name="username" id="username" runat="server" placeholder="User Name"
                                required="required" data-validation-required-message="Please enter User Name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="password" class="form-control" name="password" id="password" runat="server" placeholder="Password"
                                required="required" data-validation-required-message="Please enter password" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="password" class="form-control" name="rpassword" id="rpassword" runat="server" placeholder="Repeat Password"
                                required="required" data-validation-required-message="Please enter password" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        ...
                        <div>
                                <asp:Button ID="btnSubmit" runat="server" class="btn btn-primary py-2 px-4" Text="Save Form" OnClick="btnSubmit_Click" />
                        </div>
