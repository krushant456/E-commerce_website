<%@ Page Language="C#" AutoEventWireup="true" CodeFile="genOrder.aspx.cs" EnableEventValidation="false" Inherits="ProductDet" %>
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Generation of Order</h1>
    ...
    <div class="container-fluid py-5">
         <div class="text-center mb-4">
             <asp:Label ID="Label2" runat="server" Text="" BackColor="#FFFF99" BorderColor="#003300" BorderStyle="Double" BorderWidth="3" Enabled="True" Font-Size="Larger" Font-Bold="True" ForeColor="#CC0000" Height="40"></asp:Label>
         </div>
    </div>
    <!-- Shop Detail End -->
    ...
    <div class="container-fluid py-5">
        <div class="text-center mb-4">
            <asp:LinkButton ID="Button1" runat="server" Text="Continue With Surfing" BackColor="#99FF99" BorderColor="#003300" BorderStyle="Ridge" BorderWidth="2" Font-Bold="True" Font-Size="Large" ForeColor="#CC0000" Height="40" Width="250" PostBackUrl="~/index.aspx" />
        </div>
