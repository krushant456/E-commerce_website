                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a ID="linkuseracc" class="nav-item nav-link" href="useraccount.aspx" Visible="false" runat="server">Your Account</a>
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Order Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <a href="cart.aspx" class="btn btn-outline-primary py-md-2 px-md-3">Order Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div >
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <h6 class="text-truncate mb-3"><strong>Sale By : </strong><%#Eval("user_name")%></h6>
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    <h2 class="section-title px-5 mb-3"><span class="bg-secondary px-2">FeedBack/Query</span></h2>
                    <p>Provide your Email-id, we will contact you back.</p>
                </div>
                <form action="">
                    <div class="input-group">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div >
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3"><%#Eval("product_name")%></h6>
                        <h6 class="text-truncate mb-3">Sale By : <%#Eval("user_name")%></h6>
                        <div class="d-flex justify-content-center">
                            <h6><%#Eval("price")%></h6><h6 class="text-muted ml-2"><del><%#Eval("mrp")%></del></h6>
                        </div>
                    </div>
                    ...
                    <asp:Repeater ID="Repeater2" runat="server">
                        <ItemTemplate>
                            <div class="vendor-item border p-4">
                                <p><strong> <%#Eval("offer_title")%> </strong></p>
                                <p><strong>Discount : </strong><%#Eval("discount")%></p>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
