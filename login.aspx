<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" EnableEventValidation="true" Inherits="Register" %>
...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Login(Buyer/Seller)</h1>
    ...
    <asp:Label ID="Label1" runat="server" Text="" Font-Bold="True" Font-Size="Medium"></asp:Label></div>
                        ...
                        <div>
                            <a href="Register.aspx">Not Registered, Click Here...</a>
                            <a href="ForgetPass.aspx">Forget Password, Click Here...</a>
                        </div>
                        <div>
                                <asp:Button ID="btnSubmit" runat="server" class="btn btn-primary py-2 px-4" Text="LOGIN" OnClick="btnSubmit_Click" />
                        </div>
